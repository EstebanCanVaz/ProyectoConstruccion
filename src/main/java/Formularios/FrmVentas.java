...
public class FrmVentas extends javax.swing.JInternalFrame {
    ...
    private void txtBuscarProductosKeyReleased(java.awt.event.KeyEvent evt) {
    }
    ...
    private void btmAgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void btmEliminarResumenVentaActionPerformed(java.awt.event.ActionEvent evt) {
    }
    private void btmCobrarActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void btmHabilitarActionPerformed(java.awt.event.ActionEvent evt) {
